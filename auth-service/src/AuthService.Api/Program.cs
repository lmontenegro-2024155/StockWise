...
// Apply named CORS policy first so the framework handles CORS preflight and headers.
...
app.UseSecurityHeaders(policies => policies
    ...
    .AddContentSecurityPolicy(builder =>
    {
        ...
        builder.AddConnectSrc().Self()
            ...
            .From("http://10.0.2.2:5173")
            .From("http://10.0.2.2:5296")
            .From("http://192.168.1.34:5173")
            .From("http://192.168.1.34:5296")
